...
6. `convert_namespace "original_asis"` — 名前空間変換: `original_asis` → `emulated_asis`
7. conduit snapshot ごとに `convert_namespace` — `original_asis_conduit<X>` → `emulated_asis_conduit<X>`
8. netoviz index に `emulated_asis*` エントリを追加
