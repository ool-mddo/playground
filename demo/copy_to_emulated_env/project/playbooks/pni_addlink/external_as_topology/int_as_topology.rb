...
def find_layer3_tp_ip_addr(int_as_topology, layer3_node_name, layer3_tp_name)
    ...
    bgp_proc_node.termination_points.each do |bgp_proc_tp|
      ...
      peer_item = {
        ...
        layer3: {
          ...
          ip_addr: find_layer3_tp_ip_addr(int_as_topology, layer3_ref.ref_node, layer3_ref.ref_tp)
        }
      }
