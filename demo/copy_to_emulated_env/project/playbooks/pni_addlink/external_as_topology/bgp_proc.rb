...
def register_bgp_proc(nws)
  nws.register do
    network 'bgp_proc' do
      ...
      bdlink %w[AS65550-1 peer_169.254.0.6 AS65550ADD peer_169.254.0.5]
      node 'AS65550-2' do
      ...
      bdlink %w[AS65550-2 peer_169.254.0.10 AS65550ADD peer_169.254.0.9]
      node 'AS65550ADD' do
        support %w[layer3 AS65550ADD]
        attribute(
          flags: %w[ext-bgp-speaker],
          router_id: '0.0.0.3' # TODO
        )
        term_point 'peer_169.254.0.5' do
          support %w[layer3 AS65550ADD  Ethernet2]
          attribute(
            local_as: 65_550,
        ...
        term_point 'peer_169.254.0.9' do
          support %w[layer3 AS65550ADD  Ethernet3]
          attribute(
            local_as: 65_550,
      ...
      bdlink %w[AS65520-1 peer_169.254.0.14 AS65520-3 peer_169.254.0.13]
      node 'AS65520-3' do
