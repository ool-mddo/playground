  ...
  nws.register do
    network 'layer3' do
      ...
      node 'Seg_10.0.4.0/24' do
        ...
        term_point 'AS65550ADD_Ethernet4'
        term_point 'endpoint01-iperf0_Ethernet1'
      end
      bdlink %w[AS65550ADD Ethernet4 Seg_10.0.4.0/24 AS65550ADD_Ethernet4]
      bdlink %w[endpoint01-iperf0 Ethernet1 Seg_10.0.4.0/24 endpoint01-iperf0_Ethernet1]
      ...
      node 'Seg_10.0.1.0/24' do
        ...
        term_point 'AS65550ADD_Ethernet5'
        term_point 'endpoint01-iperf1_Ethernet1'
      end
      bdlink %w[AS65550ADD Ethernet5 Seg_10.0.1.0/24 AS65550ADD_Ethernet5]
      bdlink %w[endpoint01-iperf1 Ethernet1 Seg_10.0.1.0/24 endpoint01-iperf1_Ethernet1]
      ...
      node 'Seg_10.0.2.0/24' do
        ...
        term_point 'AS65550ADD_Ethernet6'
        term_point 'endpoint01-iperf2_Ethernet1'
      end
      bdlink %w[AS65550ADD Ethernet6 Seg_10.0.2.0/24 AS65550ADD_Ethernet6]
      bdlink %w[endpoint01-iperf2 Ethernet1 Seg_10.0.2.0/24 endpoint01-iperf2_Ethernet1]
      ...
      node 'Seg_10.0.3.0/24' do
        ...
        term_point 'AS65550ADD_Ethernet7'
        term_point 'endpoint01-iperf3_Ethernet1'
      end
      bdlink %w[AS65550ADD Ethernet7 Seg_10.0.3.0/24 AS65550ADD_Ethernet7]
      ...
      bdlink %w[AS65520-3 Ethernet3 Seg_10.120.0.0/24 AS65520-3_Ethernet3]
      ...
      bdlink %w[AS65520-1 Ethernet3 Seg_10.100.0.0/24 AS65520-1_Ethernet3]
      ...
      bdlink %w[endpoint02-iperf2 Ethernet1 Seg_10.130.0.0/24 endpoint02-iperf2_Ethernet1]
      ...
      bdlink %w[AS65520-3 Ethernet4 Seg_10.110.0.0/24 AS65520-3_Ethernet4]
