...
def register_layer3(nws)
  nws.register do
    network 'layer3' do
      ...
      bdlink %w[AS65550-1 Ethernet3 Seg_169.254.0.0/30 AS65550-1_Ethernet3]
      ...
      bdlink %w[AS65520-1 Ethernet2 Seg_169.254.0.4/30 AS65520-1_Ethernet2]
      bdlink %w[AS65520-2 Ethernet2 Seg_169.254.0.4/30 AS65520-2_Ethernet2]
      ...
      bdlink %w[AS65520-1 Ethernet3 Seg_169.254.0.8/30 AS65520-1_Ethernet3]
      bdlink %w[AS65520-3 Ethernet2 Seg_169.254.0.8/30 AS65520-3_Ethernet2]
      ...
      bdlink %w[AS65520-2 Ethernet3 Seg_169.254.0.12/30 AS65520-2_Ethernet3]
      bdlink %w[AS65520-3 Ethernet3 Seg_169.254.0.12/30 AS65520-3_Ethernet3]
      ...
      bdlink %w[endpoint01-iperf0 Ethernet1 Seg_10.0.3.0/24 endpoint01-iperf0_Ethernet1]
      ...
      bdlink %w[AS65550-1 Ethernet5 Seg_10.0.2.0/24 AS65550-1_Ethernet5]
      ...
      node 'Seg_10.0.1.0/24' do
        ...
        term_point 'AS65550-1_Ethernet6'
        term_point 'endpoint01-iperf2_Ethernet1'
      end
      bdlink %w[AS65550-1 Ethernet6 Seg_10.0.1.0/24 AS65550-1_Ethernet6]
      ...
      node 'Seg_10.0.4.0/24' do
        ...
        term_point 'AS65550-1_Ethernet7'
        term_point 'endpoint01-iperf3_Ethernet1'
      end
      bdlink %w[AS65550-1 Ethernet7 Seg_10.0.4.0/24 AS65550-1_Ethernet7]
      ...
      bdlink %w[AS65520-1 Ethernet4 Seg_10.120.0.0/24 AS65520-1_Ethernet4]
      bdlink %w[endpoint02-iperf0 Ethernet1 Seg_10.120.0.0/24 endpoint02-iperf0_Ethernet1]
      ...
      bdlink %w[AS65520-1 Ethernet5 Seg_10.130.0.0/24 AS65520-1_Ethernet5]
      bdlink %w[endpoint02-iperf1 Ethernet1 Seg_10.130.0.0/24 endpoint02-iperf1_Ethernet1]
      ...
      node 'Seg_10.100.0.0/24' do
        ...
        term_point 'AS65520-1_Ethernet6'
        term_point 'endpoint02-iperf2_Ethernet1'
      end
      bdlink %w[AS65520-1 Ethernet6 Seg_10.100.0.0/24 AS65520-1_Ethernet6]
      bdlink %w[endpoint02-iperf2 Ethernet1 Seg_10.100.0.0/24 endpoint02-iperf2_Ethernet1]
      ...
      bdlink %w[AS65520-2 Ethernet4 Seg_10.110.0.0/24 AS65520-2_Ethernet4]
      bdlink %w[endpoint02-iperf3 Ethernet1 Seg_10.110.0.0/24 endpoint02-iperf3_Ethernet1]
