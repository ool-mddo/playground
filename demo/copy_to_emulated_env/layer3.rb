    ...
    network 'layer3' do
      ...
      node 'AS65550-1' do
        ...
        term_point 'Ethernet2' do
          attribute( ip_addrs: %w[100.0.0.1/30] )
        end
        term_point 'Ethernet3' do
          attribute( ip_addrs: %w[100.0.0.5/30] )
        end
      ...
      node 'AS65550-2' do
        ...
        term_point 'Ethernet2' do
          attribute( ip_addrs: %w[100.0.0.2/30] )
        end
        term_point 'Ethernet3' do
          attribute( ip_addrs: %w[100.0.0.9/30] )
        end
        term_point 'Ethernet4' do
      ...
      node 'AS65550-3' do
        ...
        term_point 'Ethernet2' do
          attribute( ip_addrs: %w[100.0.0.6/30] )
        end
        term_point 'Ethernet3' do
          attribute( ip_addrs: %w[100.0.0.10/30] )
        end
      end
      node 'AS65520-1' do
        attribute( node_type: 'node' )
        ...
        term_point 'Ethernet2' do
          attribute( ip_addrs: %w[100.0.0.13/30] )
        end
        term_point 'Ethernet3' do
          attribute( ip_addrs: %w[100.0.0.17/30] )
        end
        term_point 'Ethernet4' do
      ...
      node 'AS65520-2' do
        ...
        term_point 'Ethernet2' do
          attribute( ip_addrs: %w[100.0.0.14/30] )
        end
        term_point 'Ethernet3' do
          attribute( ip_addrs: %w[100.0.0.21/30] )
        end
        term_point 'Ethernet4' do
      ...
      node 'AS65520-3' do
        ...
        term_point 'Ethernet2' do
          attribute( ip_addrs: %w[100.0.0.18/30] )
        end
        term_point 'Ethernet3' do
          attribute( ip_addrs: %w[100.0.0.22/30] )
        end
        term_point 'Ethernet4' do
          attribute( ip_addrs: %w[10.110.0.1/20] )
        end
      end
      node 'Seg_100.0.0.0/30' do
        attribute( node_type: 'segment', prefixes: [{ prefix: '100.0.0.0/30', metric: 0 }] )
        term_point 'AS65550-1_Ethernet2'
        term_point 'AS65550-2_Ethernet2'
      end
      bdlink %w[AS65550-1 Ethernet2 Seg_100.0.0.0/30 AS65550-1_Ethernet2]
      bdlink %w[AS65550-2 Ethernet2 Seg_100.0.0.0/30 AS65550-2_Ethernet2]
      node 'Seg_100.0.0.4/30' do
        attribute( node_type: 'segment', prefixes: [{ prefix: '100.0.0.4/30', metric: 0 }] )
        term_point 'AS65550-1_Ethernet3'
        term_point 'AS65550-3_Ethernet2'
      end
      bdlink %w[AS65550-1 Ethernet3 Seg_100.0.0.4/30 AS65550-1_Ethernet3]
      bdlink %w[AS65550-3 Ethernet2 Seg_100.0.0.4/30 AS65550-3_Ethernet2]
      node 'Seg_100.0.0.8/30' do
        attribute( node_type: 'segment', prefixes: [{ prefix: '100.0.0.8/30', metric: 0 }] )
        term_point 'AS65550-2_Ethernet3'
        term_point 'AS65550-3_Ethernet3'
      end
      bdlink %w[AS65550-2 Ethernet3 Seg_100.0.0.8/30 AS65550-2_Ethernet3]
      bdlink %w[AS65550-3 Ethernet3 Seg_100.0.0.8/30 AS65550-3_Ethernet3]
      node 'Seg_100.0.0.12/30' do
        attribute( node_type: 'segment', prefixes: [{ prefix: '100.0.0.12/30', metric: 0 }] )
        term_point 'AS65520-1_Ethernet2'
        term_point 'AS65520-2_Ethernet2'
      end
      bdlink %w[AS65520-1 Ethernet2 Seg_100.0.0.12/30 AS65520-1_Ethernet2]
      bdlink %w[AS65520-2 Ethernet2 Seg_100.0.0.12/30 AS65520-2_Ethernet2]
      node 'Seg_100.0.0.16/30' do
        attribute( node_type: 'segment', prefixes: [{ prefix: '100.0.0.16/30', metric: 0 }] )
        term_point 'AS65520-1_Ethernet3'
        term_point 'AS65520-3_Ethernet2'
      end
      bdlink %w[AS65520-1 Ethernet3 Seg_100.0.0.16/30 AS65520-1_Ethernet3]
      bdlink %w[AS65520-3 Ethernet2 Seg_100.0.0.16/30 AS65520-3_Ethernet2]
      node 'Seg_100.0.0.20/30' do
        attribute( node_type: 'segment', prefixes: [{ prefix: '100.0.0.20/30', metric: 0 }] )
        term_point 'AS65520-2_Ethernet3'
        term_point 'AS65520-3_Ethernet3'
      end
      bdlink %w[AS65520-2 Ethernet3 Seg_100.0.0.20/30 AS65520-2_Ethernet3]
      bdlink %w[AS65520-3 Ethernet3 Seg_100.0.0.20/30 AS65520-3_Ethernet3]
      ...
      bdlink %w[AS65550-2 Ethernet4 Seg_10.0.1.0/24 AS65550-2_Ethernet4]
      bdlink %w[endpoint01-iperf0 Ethernet1 Seg_10.0.1.0/24 endpoint01-iperf0_Ethernet1]
      ...
      bdlink %w[AS65550-1 Ethernet4 Seg_10.0.2.0/24 AS65550-1_Ethernet4]
      bdlink %w[endpoint01-iperf1 Ethernet1 Seg_10.0.2.0/24 endpoint01-iperf1_Ethernet1]
      ...
      node 'Seg_10.0.3.0/24' do
        ...
        term_point 'AS65550-1_Ethernet5'
        term_point 'endpoint01-iperf2_Ethernet1'
      end
      bdlink %w[AS65550-1 Ethernet5 Seg_10.0.3.0/24 AS65550-1_Ethernet5]
      bdlink %w[endpoint01-iperf2 Ethernet1 Seg_10.0.3.0/24 endpoint01-iperf2_Ethernet1]
      ...
      bdlink %w[endpoint01-iperf3 Ethernet1 Seg_10.0.4.0/24 endpoint01-iperf3_Ethernet1]
      ...
      bdlink %w[AS65520-1 Ethernet4 Seg_10.130.0.0/21 AS65520-1_Ethernet4]
      bdlink %w[endpoint02-iperf0 Ethernet1 Seg_10.130.0.0/21 endpoint02-iperf0_Ethernet1]
      ...
      node 'Seg_10.100.0.0/16' do
        ...
        term_point 'AS65520-2_Ethernet4'
        term_point 'endpoint02-iperf1_Ethernet1'
      end
      bdlink %w[AS65520-2 Ethernet4 Seg_10.100.0.0/16 AS65520-2_Ethernet4]
      bdlink %w[endpoint02-iperf1 Ethernet1 Seg_10.100.0.0/16 endpoint02-iperf1_Ethernet1]
      ...
      bdlink %w[AS65520-3 Ethernet4 Seg_10.110.0.0/20 AS65520-3_Ethernet4]
      bdlink %w[endpoint02-iperf2 Ethernet1 Seg_10.110.0.0/20 endpoint02-iperf2_Ethernet1]
      ...
      node 'Seg_10.120.0.0/17' do
        ...
        term_point 'AS65520-1_Ethernet5'
        term_point 'endpoint02-iperf3_Ethernet1'
      end
      bdlink %w[AS65520-1 Ethernet5 Seg_10.120.0.0/17 AS65520-1_Ethernet5]
      bdlink %w[endpoint02-iperf3 Ethernet1 Seg_10.120.0.0/17 endpoint02-iperf3_Ethernet1]
